...
const RiwayatTransaksi = () => {
  ...
  const [reservasiId, setReservasiId] = useState(null); // Add state variable for reservasiId
            ...
            <table className="w-full text-sm text-left text-gray-500">
              <thead className="text-xs text-gray-700 uppercase bg-gray-100">
                ...
                <th className="py-3 px-1 text-center">No</th>
                    ...
                    <th className="py-3 px-1 text-center">Customer ID</th>
                    <th className="py-3 px-1 text-center">Tanggal Checkin</th>
              ...
              {filteredData.map((reservasi, index) => (
                  <tr className="bg-white border-b" key={reservasi.id}>
                    ...
                    <td className="py-3 px-6 text-center">{reservasi.id_customer}</td>
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`font-medium px-3 py-1 rounded text-white ${
                          reservasi.status_reservasi === "Dibatalkan" ? "bg-gray-400 cursor-not-allowed" : "bg-red-400 hover:bg-red-500"
                        }`}
                        disabled={reservasi.status_reservasi === "Dibatalkan"}
                      >
                        Batalkan
                      </button>
                    </td>
