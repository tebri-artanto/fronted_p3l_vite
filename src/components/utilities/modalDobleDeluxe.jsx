        ...
        <ModalBody>
          ...
          <Box p={4} borderWidth="1px" borderRadius="md">
            ...
            <Text fontSize="sm" mb={2}>
              Kapasitas: 2 orang | Pilihan tempat tidur: 1 double, 2 twin
            </Text>
            <Divider my={2} />
            {/* Room Features */}
            ...
            <Box>
              ...
              <Text fontSize="sm">
                - Makan Minum: Pembuat kopi/teh, minibar, layanan kamar 24-jam
              </Text>
            ...
            <Box>
              <Text fontSize="sm">
                - AC dan layanan pembenahan kamar harian
              </Text>
              <Text fontSize="sm">
                - Tempat tidur premium dan seprai kualitas premium
              </Text>
...
export default ModalDoubleDeluxe;
